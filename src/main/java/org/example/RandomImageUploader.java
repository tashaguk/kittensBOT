...
public class RandomImageUploader {
    ...
    public static void sendPostRequestWithImage(String serverUrl, String textBody, File files) {
        ...
        String[] channelIds = {"3ex6yj6pginmmk1b9rt94gw4fe", "iyxrxcupk3y5dxs3y9gzrj49bo", "i14kpdfrgjbg9jjtytnegnoxeh", "gp6ip5qngpdz3d86jzi9y1u5ec", "u8s6nqjrmpb9fku5oh7gai61ne", "fr8w6fpuhbfy5pbsx9dtsmsa6a", "ur7n68t7cpg3pkbj4i7s8gxwww", "pcsryboejfrpfj31fpuxrgx48y", "r8p97neaa38zz8dajstd39bzro", "ezybkpjbupyotrhruq93sfnjuo", "4n7igrrrctdodjzmh1oeutj3da", "7j1mpngcajgm7x876bjjow74qa", "9xzftak5b7g65d6aoqt91ojnne", "znd4dpa3mjryif8kkzyxe9wkxh", "ihz3prkdib8obc7fwc1jntfqcy"};

        String[] userIds = {"5cubkbo9hpbczc6n598ge9nawa", "wnfdd1kbmin47duiezqt6dewke", "kcy7zyz4eb8x3q3nrz7d7aidzh", "cymfc8wge3gozdog3a19xmnc4y", "d784n6k1htdyjd854wwtsn1g8c", "zr97oirpufdeuks113c8qk4kka", "azm6tyjhr3gniykg5rw9s9g4oh", "dy9de1xuiiyf5ynnnsziaj1ddy", "17bqhsn1p7n19eqk38am9cap3y", "fwb3g1x5gjrkjdqqfzkm466qko", "7yxzj1u9xfyqzcb4jnk1dryjxa", "hj637brabin8ppddtuamwjqq6c", "gd9gtxiazjrp3xj89gsw6wu3ky", "pkxr9upobfnd7rorajhih46yeo", "wc65b5bjnt8zbgy381jyjnf3bw"};
        ...
        for (int i = 0; i < channelIds.length; i++) { //
            ...
            try {
                ...
                if (responseEntity != null) {
                    ...
                    jsonNode.put("message", "Доброго пятничного утра! :feet:");
